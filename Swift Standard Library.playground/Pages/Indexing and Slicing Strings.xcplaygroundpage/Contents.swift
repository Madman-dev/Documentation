...
str.count
str.utf16.count
// 이모지들이 utf16에 해당되기 때문인가? > utf 16에 해당 하는 값들이 기존 str 값들보다 크게 고려되기 때문에 값이 다르게 나오는 것 같은데
/*:
...
// in Swift, strings are considered as collection of grapheme clusters -> these do not have a fixed size and cannot be indexed like an array
/*:
...
*/
str[str.index(str.af, offsetBy: 7)]
visualize(str, index: str.index(str.startIndex, offsetBy: 1))
//visualize(str, index: str.index(str.startIndex, offsetBy: 13))
