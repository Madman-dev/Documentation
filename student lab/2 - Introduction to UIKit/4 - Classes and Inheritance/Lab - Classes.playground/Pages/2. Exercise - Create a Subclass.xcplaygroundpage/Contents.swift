...
class Fighter: Spaceship {
    ...
    func fire() {
        ...
        } else if remainingFirepower <= 0 {  /// < 0 면 값이 출력되지 않는다
...
//print(falcon.weapon)
///falcon was stated in a different file, unable to reach falcon within scope
///
///⭐️ weapon is an instance of Fighter, not spaceship -> unable to reach since falcon is an instance of the root class Spaceship
