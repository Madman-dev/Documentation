...
var home = Rectangle(width: 10, height: 10)
home.area
...
//let myHeight = Height(heightInCentimeters: 174)
//print(myHeight)
//
//let yourHeight = Height(heightInInches: 68)
//print(yourHeight)

var height = Height(heightInInches: 68)
print(height)
