...
let favoriteBook = Book(title: "SlamDunk", pages: 125, author: "Hoshino", price: 1000)
print(favoriteBook)
...
let secondLaptop = Laptop(yearPurchased: 2022)
print(firstLaptop)
print(secondLaptop)
...
//let jack = Height(heightInInches: 65)
//print(jack)
...
var myHeight = Height(heightInCentimeters: 174)
//var myHeight = Height(heightInInches: <#T##Double#>)
print(myHeight)
