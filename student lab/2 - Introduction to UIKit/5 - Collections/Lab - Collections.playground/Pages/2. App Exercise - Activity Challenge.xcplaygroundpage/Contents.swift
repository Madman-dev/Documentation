 ...
 */
var walkingChallenge: [String] = ["walk 1km everyday", "tour around the block"]
var runningChallenge: [String] = ["run threadmill 30 miunutes everyday", "run atleast 3km"]
...
var challenges = [walkingChallenge, runningChallenge]   /// 애초에 array에 들어있으니 [[], []] 구성으로 하지 않아도 되네?
print(challenges[1][0]) // 2번째 Array의 첫번째 포인트만!
//:  All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
challenges.removeAll()  // array는 계속해서 값을 넣는 친구니까 let이 아닌 var로 만드는게 좋겠네
print(challenges)
