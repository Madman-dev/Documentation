...
if nameInCaps == name {
    ...
    print("The two strings are not equal")  // The code looks into the cases of all the languages
}
...
junior.hasSuffix("Jr.") ? print("We found a second generation name!") : print("There's no offspring of Ripken...")
...
if textToSearchThrough.lowercased().contains(textToSearchFor.lowercased()) {
    ...
    print("There's not \(textToSearchFor) in the phrase")
}
