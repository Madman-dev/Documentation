 ...
 */
let newHeartRate1: Double = 60
let newHeartRate2: Double = 75
let newHeartRate3: Double = 82

let averageHeartRate: Double = (newHeartRate1 + newHeartRate2 + newHeartRate3) / 3
