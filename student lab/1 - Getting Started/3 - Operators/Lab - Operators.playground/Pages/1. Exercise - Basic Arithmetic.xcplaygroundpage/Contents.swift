...
//print what you would expect의 의미가 내가 진짜 생각하는 값을 출력시키라는 부분이었구나
print(3)
...
/// The data that holds integerDivisionResult is an Integer, They only hold whole values which are unable to take in decimal points. Thus making a difference in the types of data held by the constants.
/*:
...
//you can check through as follows
let ifEven: Bool = even % 2 == 0
